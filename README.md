[![Java CI with Gradle](https://github.com/komshuk/Selenium/actions/workflows/gradle.yml/badge.svg)](https://github.com/komshuk/Selenium/actions/workflows/gradle.yml)
